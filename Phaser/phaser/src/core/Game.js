...
* @param {number} [renderer=Phaser.；] - Which renderer to use: Phaser.AUTO will auto-detect, Phaser.WEBGL, Phaser.CANVAS or Phaser.HEADLESS (no rendering at all).
...
Phaser.Game = function (width, height, renderer, parent, state, transparent, antialias, physicsConfig) {
    ...
    /**
    * @property {number} id - Phaser Game ID (for when Pixi supports multiple instances（多例）).
    * @readonly
    */
    ...
    * @default
    */
    this.preserveDrawingBuffer = false;//渲染后是否保存模板缓冲区的内容
    ...
    * @default
    */
    this.clearBeforeRender = true;//渲染显示列表之前清除每帧Canvas
    ...
    * @protected
    */
    this.raf = null;//通过requestAnimationFrame或setTimeout自动处理核心游戏循环
